...
import com.example.CapstoneProject.IOrder.activity.MainActivity;
...
import static com.example.CapstoneProject.IOrder.activity.CartActivity.priceAdjust;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final CartViewHolder holder, final int position) {
        ...
        holder.cartPrice.setText((Double.toString((cartFoods.get(position).getPrice()))) + " AD");
